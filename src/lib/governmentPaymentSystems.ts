...
export const governmentPaymentSystems: Record<string, GovernmentPaymentSystem> = {
  ...
  KW: {
    ...
    gradients: {
      ...
      secondary: 'linear-gradient(135deg, #CE1126, #007A3D)',
      header: 'linear-gradient(180deg, #007A3D 0%, #CE1126 100%)',
    },
    shadows: {
      sm: '0 1px 2px 0 rgba(0, 122, 61, 0.08)',
      md: '0 4px 6px -1px rgba(0, 122, 61, 0.12)',
      lg: '0 10px 15px -3px rgba(0, 122, 61, 0.18)',
    },
    borderRadius: {
      sm: '6px',
      md: '10px',
