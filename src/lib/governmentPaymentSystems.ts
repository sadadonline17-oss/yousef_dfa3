...
export const governmentPaymentSystems: Record<string, GovernmentPaymentSystem> = {
  ...
  KW: {
    ...
    gradients: {
      primary: 'linear-gradient(135deg, #0066CC, #003D82)',
      secondary: 'linear-gradient(135deg, #FFCC00, #FFB700)',
      header: 'linear-gradient(180deg, #0066CC 0%, #FFCC00 100%)',
    },
    shadows: {
      sm: '0 1px 2px 0 rgba(0, 102, 204, 0.05)',
      md: '0 4px 6px -1px rgba(0, 102, 204, 0.1)',
      lg: '0 10px 15px -3px rgba(0, 102, 204, 0.15)',
    },
    borderRadius: {
      sm: '6px',
      md: '10px',
